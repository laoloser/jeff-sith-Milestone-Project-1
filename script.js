...
// Define an array of song names with their respective paths
const songList = [
    { name: 'No Music', path: '' },
...
// Add event listener for click events on the music toggle button
...
function playSelectedSong() {
    ...
    // Check if a valid song path is selected
    if (selectedSongPath) {
        ...
        // No song selected or default "No Music" selected
